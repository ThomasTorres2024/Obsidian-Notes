...
Since our [[Norm]] are well defined, we can simply extend the notion through the finding the maximum of the ratio over all values of $\vec{x}$. We suppose that this ratio is actually equal to $\sigma_{1}$, that is the largest singular value of the [[Single Value Decomposition]] of our matrix.. 
