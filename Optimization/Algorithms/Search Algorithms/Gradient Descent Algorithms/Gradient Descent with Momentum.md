...
We are still using the same function as in the original [[Optimization/Algorithms/Search Algorithms/Gradient Descent Algorithms/Gradient Descent]] problem, so:
