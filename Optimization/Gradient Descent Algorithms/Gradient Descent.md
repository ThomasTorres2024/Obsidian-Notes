...
We can determine the convergence of the [[Optimization/Gradient Descent Algorithms/Gradient Descent]] algorithm by considering the smallest and largest [[eigen value]]s when a matrix is a [[Symmetric Matrix]]. If the matrix were not symmetric, the maximum [[Singular Value]] over the minimum singular value would be used:
...
Let us write out the [[Optimization/Gradient Descent Algorithms/Gradient Descent]] for this function:
