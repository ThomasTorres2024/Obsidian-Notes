...
It is not directly a programming language, because we can implement classes on top of existing [[Functional Language]]s, [[Programming Language]]s, and [[Imperative Language]]s. 